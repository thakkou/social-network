-- SEEDER MIGRATION
-- Matches the data from backend/pkg/db/sqlite/seeder/*.go
-- Password hash: $2a$10$WKwmrHpemaSqsTWBATFNDO3VWX23TS9bEqA0FRkJVsYPS9OKRebV.  ==> 'password'
-- The Go seeder uses bcrypt hash of "password123"
