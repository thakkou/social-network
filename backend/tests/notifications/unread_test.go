...
func TestGetNotifications_All(t *testing.T) {
	...
	// User 1 (Alice) has notifications in the seed data
...
func TestGetNotifications_Unread(t *testing.T) {
	server, db, err := setup.NewTestServerWithDefaults()
	if err != nil {
		t.Fatal(err)
	}
...
func TestMarkNotificationRead(t *testing.T) {
	...
	body, err := setup.POST(server, "/api/notifications/read?id=1").
		WithAuth(sessionID).
		DoStatus(200)
...
func TestMarkAllNotificationsRead(t *testing.T) {
	...
	body, err := setup.POST(server, "/api/notifications/readAll").
		WithAuth(sessionID).
		DoStatus(200)
...
func TestDeleteNotification(t *testing.T) {
	...
	// Notification 2 belongs to user 1 (Alice) - see seeder_test.sql
	sessionID, err := setup.CreateSession(db, 1)
	if err != nil {
		t.Fatal(err)
	}

	body, err := setup.DELETE(server, "/api/notifications/delete?id=2").
		WithAuth(sessionID).
		DoStatus(200)
...
func TestDeleteAllNotifications(t *testing.T) {
	...
	body, err := setup.DELETE(server, "/api/notifications/deletAll").
		WithAuth(sessionID).
		DoStatus(200)
...
func TestNotifications_Unauthenticated(t *testing.T) {
	...
	resp, err := setup.GET(server, "/api/notifications").Do()
	if err != nil {
		t.Fatal(err)
	}
